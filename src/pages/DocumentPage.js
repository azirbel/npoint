...
import {
  readableEvalError,
  readableParseError
} from "../helpers/readableJsonError";
  ...
  async updateJson(newOriginalContents) {
    ...
    Document.update(this.props.params.documentToken, {
      ...
      () => {
        this.setState({
          isSaving: false,
          errorMessage: "Server error, could not save"
        });
      }
    );
  }
  ...
  render() {
    ...
    return (
      <div className="document-page">
        <Header>{this.renderEditableTitle()}</Header>
        <iframe
          ...
          !this.state.editable && (
            <div className="banner dark-gray">
              <div className="container flex align-center justify-center">
                ...
                This document belongs to another user. Log in to make changes,
                or make a copy.
              </div>
            </div>
          )}
